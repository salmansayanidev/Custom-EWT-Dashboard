                ...
                <div class="col-12">
                    <div class="smart-box-main">
                        <div class="row mb-5">
                            <div class="col-12 col-lg-6">
                                <div class="">
                                    <h3 class="port-analysis-title">Companies</h3>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <ul class="filter-btns-right-list">
                                    <li class="filter-btns-left-list-item">
                                        <div class="year-radio-area position-relative">
                                            <span class="year-text fw-bold">Jan 19,2022 TO Jan 19,2023</span>
                                            <div class="year-radio-inner">
                                                <input type="radio" class="d-none year-radio" checked name="companies_year_radio" value="" id="companies-1Month">
                                                <label for="companies-1Month" class="year-radio-label">
                                                    1 Month
                                                </label>
                                            </div>
                                            <div class="year-radio-inner">
                                                <input type="radio" class="d-none year-radio" name="companies_year_radio" value="" id="companies-3Month">
                                                <label for="companies-3Month" class="year-radio-label">
                                                    3 Month
                                                </label>
                                            </div>
                                            <div class="year-radio-inner">
                                                <input type="radio" class="d-none year-radio" name="companies_year_radio" value="" id="companies-6Month">
                                                <label for="companies-6Month" class="year-radio-label">
                                                    6 Month
                                                </label>
                                            </div>
                                            <div class="year-radio-inner">
                                                <input type="radio" class="d-none year-radio" name="companies_year_radio" value="" id="companies-1year">
                                                <label for="companies-1year" class="year-radio-label">
                                                    1 Year
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="smart-box-area">
                                    <div class="smart-box-area-top">
                                        <h3 class="smart-box-title">HONGKING WANGHUA TECHNOLOGY LIMITED (HONG KONG)</h3>
                                        <div class="smart-box-btns-area">
                                            <button class="smart-box-btn red-color" type="button">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </button>
...
<script src="./assets/js/smart-box.js"></script>    